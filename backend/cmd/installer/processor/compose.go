...
const (
	composeFileRedteam       = "docker-compose.yml"
...
var composeOperationAllStacksOrder = map[ProcessorOperation][]ProductStack{
	ProcessorOperationStart:    {ProductStackObservability, ProductStackLangfuse, ProductStackGraphiti, ProductStackRedteam},
	ProcessorOperationStop:     {ProductStackRedteam, ProductStackGraphiti, ProductStackLangfuse, ProductStackObservability},
	ProcessorOperationUpdate:   {ProductStackObservability, ProductStackLangfuse, ProductStackGraphiti, ProductStackRedteam},
	ProcessorOperationDownload: {ProductStackObservability, ProductStackLangfuse, ProductStackGraphiti, ProductStackRedteam},
	ProcessorOperationRemove:   {ProductStackObservability, ProductStackLangfuse, ProductStackGraphiti, ProductStackRedteam},
	ProcessorOperationPurge:    {ProductStackObservability, ProductStackLangfuse, ProductStackGraphiti, ProductStackRedteam},
}
