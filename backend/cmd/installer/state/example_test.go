...
API_PORT=8080`
	...
	fmt.Println("=== 4RedTeam Configuration Manager ===")
	...
	state.SetVar("DATABASE_URL", "postgres://prod-server:5432/redteamdb")
	...
	// Output:
	// === 4RedTeam Configuration Manager ===
	...
	//
	// --- Current Configuration ---
	// DATABASE_URL: postgres://prod-server:5432/redteamdb [CHANGED]
