...
import (
	...
	"4redteam/cmd/installer/hardening"
	"4redteam/cmd/installer/state"
	"4redteam/cmd/installer/wizard"
)
...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "4RedTeam Installer v%s\n\n", version)
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# 4RedTeam Environment Configuration
# Generated by 4RedTeam Installer v%s
#
# This file contains environment variables for 4RedTeam configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("4RedTeam Installer v%s\n", version)
