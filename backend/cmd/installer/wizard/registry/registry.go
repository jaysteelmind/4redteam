...
import (
	...
	"4redteam/cmd/installer/wizard/models"
...
func (r *registry) initScreens() {
	...
	processorOperationForms := []models.ScreenID{
		models.InstallRedteamScreen,
		models.StartRedteamScreen,
		models.StopRedteamScreen,
		models.RestartRedteamScreen,
		models.DownloadWorkerImageScreen,
		models.UpdateWorkerImageScreen,
		models.UpdateRedteamScreen,
		models.UpdateInstallerScreen,
		models.FactoryResetScreen,
		models.RemoveRedteamScreen,
		models.PurgeRedteamScreen,
	}
