...
const (
	...
	InstallRedteamScreen      ScreenID = "processor_operation_form§all§install"
	StartRedteamScreen        ScreenID = "processor_operation_form§all§start"
	StopRedteamScreen         ScreenID = "processor_operation_form§all§stop"
	RestartRedteamScreen      ScreenID = "processor_operation_form§all§restart"
	...
	UpdateRedteamScreen       ScreenID = "processor_operation_form§compose§update"
	...
	RemoveRedteamScreen       ScreenID = "processor_operation_form§all§remove"
	PurgeRedteamScreen        ScreenID = "processor_operation_form§all§purge"
