...
func ExampleEnvFile_workflow() {
	...
	initialContent := `# 4RedTeam Configuration
...
API_KEY=old_key`
	...
	// DATABASE_URL = postgres://localhost:5432/db (default: postgres://redteamuser:redteampass@pgvector:5432/redteamdb?sslmode=disable)
	// DEBUG = false
	// API_KEY = old_key
	//
	// Configuration saved successfully!
