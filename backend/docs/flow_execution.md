# Flow Execution in 4RedTeam

This document describes the internal architecture and execution workflow of Flow in 4RedTeam, an autonomous penetration testing system that leverages AI agents to perform complex security testing workflows.
...
- **Image Chooser** - Selects optimal Docker image, fallback to `jaysteelmind/kali-redteam` for pentest
