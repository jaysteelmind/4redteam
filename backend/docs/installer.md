# 4RedTeam Installer Documentation

## Overview

The 4RedTeam installer provides a robust Terminal User Interface (TUI) for configuring the application. Built using the [Charm](https://charm.sh/) tech stack (bubbletea, lipgloss, bubbles), it implements modern responsive design patterns optimized for terminal environments.
...
const MainMenuLLMProvidersInfo = `Configure AI language model providers for 4RedTeam.
