...
import (
	...
	"4redteam/pkg/server/auth"
	"4redteam/pkg/server/logger"
	"4redteam/pkg/server/oauth"
	"4redteam/pkg/server/services"

	_ "4redteam/pkg/server/docs" // swagger docs
...
// @title 4RedTeam Swagger API
// @version 1.0
// @description Swagger API for 4RedTeam.
...
func NewRouter(
	...
	router.Use(logger.WithGinLogger("redteam-api"))
