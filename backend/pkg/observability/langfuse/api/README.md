...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=4redteam%2FGo)

The 4redteam Go library provides convenient access to the 4redteam APIs from Go.
...
import (
    client "4redteam/pkg/observability/langfuse/api/client"
    option "4redteam/pkg/observability/langfuse/api/option"
    api "4redteam/pkg/observability/langfuse/api"
    context "context"
)
